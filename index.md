...
<div class="card w-100 shadow">
  ...
  <div class="card-footer bg-light d-flex bd-highlight">
    ...
    <div class="bd-highlight"><small class="text-muted">{{ post.category }} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
